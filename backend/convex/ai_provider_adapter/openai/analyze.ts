...
function buildSystemPrompt(): string {
  return [
    ...
    "",
    "GOOD CONDITION RULE:",
    "- When the asset clearly appears in good condition with no defects, wear, or problems: return workItems: [] and clarifying_questions: [].",
    "- Do NOT invent cosmetic or low-priority work (e.g. 'clean the product', 'routine cleaning') when there is no real issue.",
    "- Only add work items for actual defects, wear, safety concerns, or functional issues that need attention.",
    "",
    "UNCERTAINTY POLICY:",
    "- clarifying_questions: Use ONLY when evidence is genuinely insufficient to assess (e.g. image too blurry, critical area not visible).",
    "- If you can confidently assess the asset (good or bad), return clarifying_questions: [].",
    "",
    "HARD RULES:",
    "- Do not invent specifics that are not visible or not provided.",
    "- MAX 3 work items. If nothing actionable, return workItems: [].",
    "- workItems can be empty; findings can be empty. Do not invent work items or findings when none exist.",
    ...
    "- recommended_parts: [] when none.",
    "- estimated_cost: null when unknown.",
    "",
    "SCORING RUBRIC:",
