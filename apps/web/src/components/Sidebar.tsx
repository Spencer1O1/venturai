...
const nav = [
  ...
  { href: "/work-items", label: "Actions", icon: ActionsIcon, badgeKey: "work-items" },
        ...
        {nav.map(({ href, label, icon: Icon, badgeKey }) => {
          ...
          return (
            ...
            >
              ...
              {badge != null ? (
                <span className={`rounded-full px-2 py-0.5 text-xs font-semibold ${isActive ? "bg-white/20" : "bg-risk-critical/90 text-white"}`}>
                  {badge}
                </span>
              ) : null}
            </Link>
