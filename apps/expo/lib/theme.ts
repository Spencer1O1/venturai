/**
 * VENTURAI brand theme – derived from the banner image.
 * Dark, futuristic tech aesthetic with electric cyan-blue accents.
 */
export const theme = {
  // Backgrounds
  background: "#0D1117",
  ...
  // Text on colored (primary/success) buttons - dark for contrast
  buttonTextOnPrimary: "#0D1117",
